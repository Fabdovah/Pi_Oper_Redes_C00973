...
/**
  ...
  *
  * @param      char * host: host address in dot/IPv6 notation, example "10.84.166.62" o "fe80::1%eno1"
...
int VSocket::TryToConnect( const char * hostip, int port ) {
   ...
   if ( !IPv6 ) {
      ...
      if ( 1 != st ) {                 // 0 = direccion invalida, -1 = error de familia
      ...
      // Soporta direcciones link-local con scope id, ej. "fe80::1%enp0s31f6"
